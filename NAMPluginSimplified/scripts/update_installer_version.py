...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NAMPluginSimplified Demo Installer\n"
      else:
        line="OutputBaseFilename=NAMPluginSimplified Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NAMPluginSimplified Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NAMPluginSimplified installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NAMPluginSimplified Demo installer\n"
     else:
       line="SetupWindowTitle=NAMPluginSimplified installer\n"
