...
def main():
  ...
  plistpath = scriptpath + "/resources/NAMPluginSimplified-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NAMPluginSimplified-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/NAMPluginSimplified-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/NAMPluginSimplified-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/NAMPluginSimplified-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/NAMPluginSimplified.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/NAMPluginSimplified.iss",inplace=1):
