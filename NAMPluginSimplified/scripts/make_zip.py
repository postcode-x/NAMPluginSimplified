...
def  main():
  ...
  installer = "\installer\NAMPluginSimplified Installer.exe"
   
  if demo:
    installer = "\installer\NAMPluginSimplified Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\NAMPluginSimplified manual.pdf" 
  ]
  ...
  ZIPNAME = "NAMPluginSimplified-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "NAMPluginSimplified-v" + FULLVERSIONSTR + "-win-demo.zip"
